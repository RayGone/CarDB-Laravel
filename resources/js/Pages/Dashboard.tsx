    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 overflow-auto">
                <div className="grid grid-cols-1 gap-1 py-3 lg:grid-cols-3 xl:grid-cols-4">
                    <div className="col-span-1 box-border sm:px-2 lg:col-span-2 lg:px-3 xl:col-span-3">
                        <div className="relative rounded-lg shadow">
                            <div className="max-h-[75vh] overflow-auto">
                                <Table
                                    ...
                                    onDelete={(id: number) => {
                                        const car = cars.cars.filter(
                                            (c) => c.id == id,
                                        );
                                        if (car.length > 0) {
                                            axiosInstance
                                                .delete(deleteMethod(id).url, {
                                                    headers: {
                    ...
                    <div className="sticky-head mr-2 box-border hidden h-fit lg:block">
                        <FilterView
                            ...
                            onRemove={(f) => {
                                const filter = {
                                    ...pageFilter,
                                    filter: pageFilter.filter.filter(
                                        (r) =>
                                            !(
                                                r.field == f.field &&
                                                r.ops == f.ops &&
                        ...
                        >
                            <span className="text-l p-2">No Filter Set.</span>
                        </FilterView>
                    </div>
                </div>
            </div>
            ...
            >
                <div
                    style={{ height: '80vh' }}
                    className="overflow-auto dark:bg-gray-900"
                >
                    <FormCar
                        car={editCar.current}
                        onCancel={() => {
