...
export default function Table({data, onFilter, onEdit, onDelete, loading=false}: TableComponentProps){
    ...
    return (
        <>
            <table className="bg-white dark:bg-slate-800 min-w-full table-auto text-xs md:text-sm lg:text-base border-collapse">
                ...
                <tbody className='text-xs'>
                    ...
                    }
                    {
                        data.cars.map((car: any)=>{
                            return <tr key={car.id} className='dark:bg-slate-800 '>
                                {
                                ...
                                <td className="px-4 py-2 bg-white dark:bg-slate-800 sticky-right border-1 dark:border-slate-500">
                                    <div className='flex flex-row dark:border-slate-700'>
                                        <button key='Edit' className='hover:bg-blue-50 text-gray dark:text-gray-50 font-bold py-3 px-3 rounded-full' onClick={()=>{onEdit(car.id)}}>
                ...
                <tfoot className='sticky-foot bg-white dark:bg-gray-800'>
